...
export default function Schedule() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-semibold mb-6">Interview Scheduler</h1>
      ...
      "
          >
            ...
            <div className="mt-2 md:mt-0 md:ml-6 text-sm text-muted-foreground whitespace-nowrap min-w-[140px] text-center md:text-left">
